defmodule Feedme.Test.Parsers.RSS2 do
  ...
  #     },
  #     last_build_date: Timex.to_datetime({{2015, 8, 16}, {9, 54, 5}}, "+0000"),
  #     publication_date: Timex.to_datetime({{2015, 8, 15}, {9, 54, 5}}, "+0000")
  #   }
  ...
  #     ttl: "60",
  #     generator: "Ghost 0.6",
  #     last_build_date: Timex.to_datetime({{2015, 8, 28}, {18, 56, 0}}, "+0000")
  #   }
  # end
  ...
  test "parse_entry", %{big_sample: big_sample} do
    ...
    assert entry == %Feedme.Entry{
      ...
      publication_date: Timex.to_datetime({{2015, 6, 8}, {13, 43, 5}}, "GMT"),
      source: nil,
  ...
  #         url: "http://localhost/image"
  #       },
  #       last_build_date: Timex.to_datetime({{2015, 8, 16}, {9, 54, 5}}, "GMT"),
  #       publication_date: Timex.to_datetime({{2015, 8, 15}, {9, 54, 5}}, "GMT")
  #     }
  #   }
  # end
end
